...
<project path="" name="Kanban" author="A.T.F" version="2.0.11" copyright="$projectName&#xD;&#xA;Copyright(c) 2022, $author" output="\script" source="False" source-dir="scripts" minify="true" min-dir="$output\build" doc="False" doc-dir="$output\docs" master="true" master-file="$output\yui-ext.js" zip="true" zip-file="$output\yuo-ext.$version.zip">
  <directory name="src" />
